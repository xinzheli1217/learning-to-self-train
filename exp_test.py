...
flags.DEFINE_string('data_path', './', 'directory for data')
...
flags.DEFINE_integer('hard_selection', 20, 'number of remaining samples (per class) after applying hard-selection')
flags.DEFINE_integer('nums_in_folders', 30, 'number of unlabeled samples (per class) used in each recurrent stage')
...
flags.DEFINE_integer('re_train_epoch_num', 10, 'number of pre_training inner gradient updates.')
...
flags.DEFINE_float('swn_lr', 0.001, 'the meta learning rate for swn')
