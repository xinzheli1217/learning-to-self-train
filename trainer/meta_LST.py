    ...
    def __init__(self):
        ...
        if FLAGS.metatrain or FLAGS.test_iter == 0:
            ...
            if FLAGS.meta_finetune:
                ...
                weights = np.load(weights_path + '/weights_' + str(FLAGS.test_iter) + '.npy').tolist()
                ss_weights = np.load(
                    weights_path + '/ss_weights_' + str(FLAGS.test_iter) + '.npy').tolist()
                fc_weights = np.load(
                    weights_path + '/fc_weights_' + str(FLAGS.test_iter) + '.npy').tolist()
